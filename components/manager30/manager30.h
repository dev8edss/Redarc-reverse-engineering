...
#include "esphome/components/battery_sensor/battery_sensor.h"
...
class Manager30Component : public Component {
 public:
  ...
  void set_battery_sensor(battery_sensor::BatterySensorComponent *b) { this->battery_sensor_ = b; }
 ...
 protected:
  ...
  battery_sensor::BatterySensorComponent *battery_sensor_{nullptr};
